        ...
        top_cards_html.append(
            ...
            <div class="signal-card" style="box-shadow: inset 0 0 0 1px {glow};">
                ...
                <div class="signal-card-meta">
                    ...
                    <span class="signal-badge {_badge_class(str(row_data["Data Health"]), "Data")}">{html.escape(str(row_data["Data Health"]))}</span>
                </div>
                <div class="signal-card-stats">
                    ...
                    <div>
                        <div class="signal-stat-label">Trend Z</div>
                        <div class="signal-stat-value">{row_data["Trend Z"]:+.2f}</div>
                    </div>
                    <div>
    ...
    for rank, row_data in enumerate(records, start=1):
        ...
        rows_html.append(
            ...
            <tr>
                ...
                <td class="{trend_class}">{row_data["Trend Z"]:+.2f}</td>
                <td class="{rvol_class}">{row_data["RVOL"]:.2f}x</td>
                <td>{int(row_data["Squeeze Bars"])}</td>
                <td>{html.escape(str(row_data["Data Health"]))}</td>
            </tr>
            """
        )
