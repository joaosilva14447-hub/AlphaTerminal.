...
def traduz_classificacao(status_en: str) -> str:
    mapa = {
    ...
    return mapa.get(status_en, status_en)

value, status_en = get_official_fear_greed()
status = traduz_classificacao(status_en)
